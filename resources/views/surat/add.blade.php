                   ...
                   <div class="card-body">
                    ...
                    <div class="row">
                      <div class="form-group col-md-3">
                        <input class="form-control form-control-lg " type="number" placeholder="No" name="urutan_surat">
                      </div>
                     ...
                     <div class="form-group col-md-4">
                      <input class="form-control form-control-lg" type="text" placeholder="Nama Surat Latin" name="nama_surat_latin">
                     </div>                     
